...
namespace crs {
  ...
  constexpr F64 PI_OVER_2 = PI / 2.0;
  constexpr F64 PI_OVER_4 = PI / 4.0;
  
  constexpr F64 deg2rad = PI / 180.0;
  constexpr F64 rad2deg = 180.0 / PI;
  
  constexpr F64 feet2meter = 0.3048;
  constexpr F64 surveyfeet2meter = 0.3048006096012;

  constexpr I32 CRS_PROJECTION_UTM = 0;
  constexpr I32 CRS_PROJECTION_LCC = 1;
  constexpr I32 CRS_PROJECTION_TM = 2;
  constexpr I32 CRS_PROJECTION_LONG_LAT = 3;
  constexpr I32 CRS_PROJECTION_LAT_LONG = 4;
  constexpr I32 CRS_PROJECTION_ECEF = 5;
  constexpr I32 CRS_PROJECTION_NONE = 6;

  constexpr I32 CRS_ELLIPSOID_NAD27 = 5;
  constexpr I32 CRS_ELLIPSOID_NAD83 = 11;
  constexpr I32 CRS_ELLIPSOID_Inter = 14;
  constexpr I32 CRS_ELLIPSOID_SAD69 = 19;
  constexpr I32 CRS_ELLIPSOID_WGS72 = 22;
  constexpr I32 CRS_ELLIPSOID_WGS84 = 23;
  constexpr I32 CRS_ELLIPSOID_ID74 = 24;
  constexpr I32 CRS_ELLIPSOID_GDA94 = CRS_ELLIPSOID_NAD83;

  constexpr I32 CRS_VERTICAL_WGS84 = 5030;
  constexpr I32 CRS_VERTICAL_NAVD29 = 5102;
  constexpr I32 CRS_VERTICAL_NAVD88 = 5103;
}  // namespace crs

class ReferenceEllipsoid {
 public:
  ReferenceEllipsoid(I32 id, const std::string& name, F64 equatorialRadius, F64 eccentricitySquared, F64 inverseFlattening)
      : id(id), name(name), equatorialRadius(equatorialRadius), eccentricitySquared(eccentricitySquared), inverseFlattening(inverseFlattening) {
  }
...
namespace pcs {
  constexpr int PCS_NAD27_Alabama_East = 26729;
  constexpr int PCS_NAD27_Alabama_West = 26730;
  constexpr int PCS_NAD27_Alaska_zone_1 = 26731; /* Hotine Oblique Mercator Projection not supported*/
  constexpr int PCS_NAD27_Alaska_zone_2 = 26732;
  constexpr int PCS_NAD27_Alaska_zone_3 = 26733;
  constexpr int PCS_NAD27_Alaska_zone_4 = 26734;
  constexpr int PCS_NAD27_Alaska_zone_5 = 26735;
  constexpr int PCS_NAD27_Alaska_zone_6 = 26736;
  constexpr int PCS_NAD27_Alaska_zone_7 = 26737;
  constexpr int PCS_NAD27_Alaska_zone_8 = 26738;
  constexpr int PCS_NAD27_Alaska_zone_9 = 26739;
  constexpr int PCS_NAD27_Alaska_zone_10 = 26740;
  constexpr int PCS_NAD27_California_I = 26741;
  constexpr int PCS_NAD27_California_II = 26742;
  constexpr int PCS_NAD27_California_III = 26743;
  constexpr int PCS_NAD27_California_IV = 26744;
  constexpr int PCS_NAD27_California_V = 26745;
  constexpr int PCS_NAD27_California_VI = 26746;
  constexpr int PCS_NAD27_California_VII = 26747;
  constexpr int PCS_NAD27_Arizona_East = 26748;
  constexpr int PCS_NAD27_Arizona_Central = 26749;
  constexpr int PCS_NAD27_Arizona_West = 26750;
  constexpr int PCS_NAD27_Arkansas_North = 26751;
  constexpr int PCS_NAD27_Arkansas_South = 26752;
  constexpr int PCS_NAD27_Colorado_North = 26753;
  constexpr int PCS_NAD27_Colorado_Central = 26754;
  constexpr int PCS_NAD27_Colorado_South = 26755;
  constexpr int PCS_NAD27_Connecticut = 26756;
  constexpr int PCS_NAD27_Delaware = 26757;
  constexpr int PCS_NAD27_Florida_East = 26758;
  constexpr int PCS_NAD27_Florida_West = 26759;
  constexpr int PCS_NAD27_Florida_North = 26760;
  constexpr int PCS_NAD27_Hawaii_zone_1 = 26761;
  constexpr int PCS_NAD27_Hawaii_zone_2 = 26762;
  constexpr int PCS_NAD27_Hawaii_zone_3 = 26763;
  constexpr int PCS_NAD27_Hawaii_zone_4 = 26764;
  constexpr int PCS_NAD27_Hawaii_zone_5 = 26765;
  constexpr int PCS_NAD27_Georgia_East = 26766;
  constexpr int PCS_NAD27_Georgia_West = 26767;
  constexpr int PCS_NAD27_Idaho_East = 26768;
  constexpr int PCS_NAD27_Idaho_Central = 26769;
  constexpr int PCS_NAD27_Idaho_West = 26770;
  constexpr int PCS_NAD27_Illinois_East = 26771;
  constexpr int PCS_NAD27_Illinois_West = 26772;
  constexpr int PCS_NAD27_Indiana_East = 26773;
  constexpr int PCS_NAD27_Indiana_West = 26774;
  constexpr int PCS_NAD27_Iowa_North = 26775;
  constexpr int PCS_NAD27_Iowa_South = 26776;
  constexpr int PCS_NAD27_Kansas_North = 26777;
  constexpr int PCS_NAD27_Kansas_South = 26778;
  constexpr int PCS_NAD27_Kentucky_North = 26779;
  constexpr int PCS_NAD27_Kentucky_South = 26780;
  constexpr int PCS_NAD27_Louisiana_North = 26781;
  constexpr int PCS_NAD27_Louisiana_South = 26782;
  constexpr int PCS_NAD27_Maine_East = 26783;
  constexpr int PCS_NAD27_Maine_West = 26784;
  constexpr int PCS_NAD27_Maryland = 26785;
  constexpr int PCS_NAD27_Massachusetts = 26786;
  constexpr int PCS_NAD27_Massachusetts_Is = 26787;
  constexpr int PCS_NAD27_Michigan_North = 26788;
  constexpr int PCS_NAD27_Michigan_Central = 26789;
  constexpr int PCS_NAD27_Michigan_South = 26790;
  constexpr int PCS_NAD27_Minnesota_North = 26791;
  constexpr int PCS_NAD27_Minnesota_Central = 26792;
  constexpr int PCS_NAD27_Minnesota_South = 26793;
  constexpr int PCS_NAD27_Mississippi_East = 26794;
  constexpr int PCS_NAD27_Mississippi_West = 26795;
  constexpr int PCS_NAD27_Missouri_East = 26796;
  constexpr int PCS_NAD27_Missouri_Central = 26797;
  constexpr int PCS_NAD27_Missouri_West = 26798;
  constexpr int PCS_NAD27_Montana_North = 32001;
  constexpr int PCS_NAD27_Montana_Central = 32002;
  constexpr int PCS_NAD27_Montana_South = 32003;
  constexpr int PCS_NAD27_Nebraska_North = 32005;
  constexpr int PCS_NAD27_Nebraska_South = 32006;
  constexpr int PCS_NAD27_Nevada_East = 32007;
  constexpr int PCS_NAD27_Nevada_Central = 32008;
  constexpr int PCS_NAD27_Nevada_West = 32009;
  constexpr int PCS_NAD27_New_Hampshire = 32010;
  constexpr int PCS_NAD27_New_Jersey = 32011;
  constexpr int PCS_NAD27_New_Mexico_East = 32012;
  constexpr int PCS_NAD27_New_Mexico_Central = 32013;
  constexpr int PCS_NAD27_New_Mexico_West = 32014;
  constexpr int PCS_NAD27_New_York_East = 32015;
  constexpr int PCS_NAD27_New_York_Central = 32016;
  constexpr int PCS_NAD27_New_York_West = 32017;
  constexpr int PCS_NAD27_New_York_Long_Is = 32018;
  constexpr int PCS_NAD27_North_Carolina = 32019;
  constexpr int PCS_NAD27_North_Dakota_N = 32020;
  constexpr int PCS_NAD27_North_Dakota_S = 32021;
  constexpr int PCS_NAD27_Ohio_North = 32022;
  constexpr int PCS_NAD27_Ohio_South = 32023;
  constexpr int PCS_NAD27_Oklahoma_North = 32024;
  constexpr int PCS_NAD27_Oklahoma_South = 32025;
  constexpr int PCS_NAD27_Oregon_North = 32026;
  constexpr int PCS_NAD27_Oregon_South = 32027;
  constexpr int PCS_NAD27_Pennsylvania_N = 32028;
  constexpr int PCS_NAD27_Pennsylvania_S = 32029;
  constexpr int PCS_NAD27_Rhode_Island = 32030;
  constexpr int PCS_NAD27_South_Carolina_N = 32031;
  constexpr int PCS_NAD27_South_Carolina_S = 32033;
  constexpr int PCS_NAD27_South_Dakota_N = 32034;
  constexpr int PCS_NAD27_South_Dakota_S = 32035;
  constexpr int PCS_NAD27_Tennessee = 2204;
  constexpr int PCS_NAD27_Texas_North = 32037;
  constexpr int PCS_NAD27_Texas_North_Central = 32038;
  constexpr int PCS_NAD27_Texas_Central = 32039;
  constexpr int PCS_NAD27_Texas_South_Central = 32040;
  constexpr int PCS_NAD27_Texas_South = 32041;
  constexpr int PCS_NAD27_Utah_North = 32042;
  constexpr int PCS_NAD27_Utah_Central = 32043;
  constexpr int PCS_NAD27_Utah_South = 32044;
  constexpr int PCS_NAD27_Vermont = 32045;
  constexpr int PCS_NAD27_Virginia_North = 32046;
  constexpr int PCS_NAD27_Virginia_South = 32047;
  constexpr int PCS_NAD27_Washington_North = 32048;
  constexpr int PCS_NAD27_Washington_South = 32049;
  constexpr int PCS_NAD27_West_Virginia_N = 32050;
  constexpr int PCS_NAD27_West_Virginia_S = 32051;
  constexpr int PCS_NAD27_Wisconsin_North = 32052;
  constexpr int PCS_NAD27_Wisconsin_Central = 32053;
  constexpr int PCS_NAD27_Wisconsin_South = 32054;
  constexpr int PCS_NAD27_Wyoming_East = 32055;
  constexpr int PCS_NAD27_Wyoming_East_Central = 32056;
  constexpr int PCS_NAD27_Wyoming_West_Central = 32057;
  constexpr int PCS_NAD27_Wyoming_West = 32058;
  constexpr int PCS_NAD27_Puerto_Rico = 32059;
  constexpr int PCS_NAD27_St_Croix = 32060;
  
  constexpr int PCS_NAD83_Alabama_East = 26929;
  constexpr int PCS_NAD83_Alabama_West = 26930;
  constexpr int PCS_NAD83_Alaska_zone_1 = 26931; /* Hotine Oblique Mercator Projection not supported*/
  constexpr int PCS_NAD83_Alaska_zone_2 = 26932;
  constexpr int PCS_NAD83_Alaska_zone_3 = 26933;
  constexpr int PCS_NAD83_Alaska_zone_4 = 26934;
  constexpr int PCS_NAD83_Alaska_zone_5 = 26935;
  constexpr int PCS_NAD83_Alaska_zone_6 = 26936;
  constexpr int PCS_NAD83_Alaska_zone_7 = 26937;
  constexpr int PCS_NAD83_Alaska_zone_8 = 26938;
  constexpr int PCS_NAD83_Alaska_zone_9 = 26939;
  constexpr int PCS_NAD83_Alaska_zone_10 = 26940;
  constexpr int PCS_NAD83_California_1 = 26941;
  constexpr int PCS_NAD83_California_2 = 26942;
  constexpr int PCS_NAD83_California_3 = 26943;
  constexpr int PCS_NAD83_California_4 = 26944;
  constexpr int PCS_NAD83_California_5 = 26945;
  constexpr int PCS_NAD83_California_6 = 26946;
  constexpr int PCS_NAD83_Arizona_East = 26948;
  constexpr int PCS_NAD83_Arizona_Central = 26949;
  constexpr int PCS_NAD83_Arizona_West = 26950;
  constexpr int PCS_NAD83_Arkansas_North = 26951;
  constexpr int PCS_NAD83_Arkansas_South = 26952;
  constexpr int PCS_NAD83_Colorado_North = 26953;
  constexpr int PCS_NAD83_Colorado_Central = 26954;
  constexpr int PCS_NAD83_Colorado_South = 26955;
  constexpr int PCS_NAD83_Connecticut = 26956;
  constexpr int PCS_NAD83_Delaware = 26957;
  constexpr int PCS_NAD83_Florida_East = 26958;
  constexpr int PCS_NAD83_Florida_West = 26959;
  constexpr int PCS_NAD83_Florida_North = 26960;
  constexpr int PCS_NAD83_Hawaii_zone_1 = 26961;
  constexpr int PCS_NAD83_Hawaii_zone_2 = 26962;
  constexpr int PCS_NAD83_Hawaii_zone_3 = 26963;
  constexpr int PCS_NAD83_Hawaii_zone_4 = 26964;
  constexpr int PCS_NAD83_Hawaii_zone_5 = 26965;
  constexpr int PCS_NAD83_Georgia_East = 26966;
  constexpr int PCS_NAD83_Georgia_West = 26967;
  constexpr int PCS_NAD83_Idaho_East = 26968;
  constexpr int PCS_NAD83_Idaho_Central = 26969;
  constexpr int PCS_NAD83_Idaho_West = 26970;
  constexpr int PCS_NAD83_Illinois_East = 26971;
  constexpr int PCS_NAD83_Illinois_West = 26972;
  constexpr int PCS_NAD83_Indiana_East = 26973;
  constexpr int PCS_NAD83_Indiana_West = 26974;
  constexpr int PCS_NAD83_Iowa_North = 26975;
  constexpr int PCS_NAD83_Iowa_South = 26976;
  constexpr int PCS_NAD83_Kansas_North = 26977;
  constexpr int PCS_NAD83_Kansas_South = 26978;
  constexpr int PCS_NAD83_Kentucky_North = 2205;
  constexpr int PCS_NAD83_Kentucky_South = 26980;
  constexpr int PCS_NAD83_Louisiana_North = 26981;
  constexpr int PCS_NAD83_Louisiana_South = 26982;
  constexpr int PCS_NAD83_Maine_East = 26983;
  constexpr int PCS_NAD83_Maine_West = 26984;
  constexpr int PCS_NAD83_Maryland = 26985;
  constexpr int PCS_NAD83_Massachusetts = 26986;
  constexpr int PCS_NAD83_Massachusetts_Is = 26987;
  constexpr int PCS_NAD83_Michigan_North = 26988;
  constexpr int PCS_NAD83_Michigan_Central = 26989;
  constexpr int PCS_NAD83_Michigan_South = 26990;
  constexpr int PCS_NAD83_Minnesota_North = 26991;
  constexpr int PCS_NAD83_Minnesota_Central = 26992;
  constexpr int PCS_NAD83_Minnesota_South = 26993;
  constexpr int PCS_NAD83_Mississippi_East = 26994;
  constexpr int PCS_NAD83_Mississippi_West = 26995;
  constexpr int PCS_NAD83_Missouri_East = 26996;
  constexpr int PCS_NAD83_Missouri_Central = 26997;
  constexpr int PCS_NAD83_Missouri_West = 26998;
  constexpr int PCS_NAD83_Montana = 32100;
  constexpr int PCS_NAD83_Nebraska = 32104;
  constexpr int PCS_NAD83_Nevada_East = 32107;
  constexpr int PCS_NAD83_Nevada_Central = 32108;
  constexpr int PCS_NAD83_Nevada_West = 32109;
  constexpr int PCS_NAD83_New_Hampshire = 32110;
  constexpr int PCS_NAD83_New_Jersey = 32111;
  constexpr int PCS_NAD83_New_Mexico_East = 32112;
  constexpr int PCS_NAD83_New_Mexico_Central = 32113;
  constexpr int PCS_NAD83_New_Mexico_West = 32114;
  constexpr int PCS_NAD83_New_York_East = 32115;
  constexpr int PCS_NAD83_New_York_Central = 32116;
  constexpr int PCS_NAD83_New_York_West = 32117;
  constexpr int PCS_NAD83_New_York_Long_Is = 32118;
  constexpr int PCS_NAD83_North_Carolina = 32119;
  constexpr int PCS_NAD83_North_Dakota_N = 32120;
  constexpr int PCS_NAD83_North_Dakota_S = 32121;
  constexpr int PCS_NAD83_Ohio_North = 32122;
  constexpr int PCS_NAD83_Ohio_South = 32123;
  constexpr int PCS_NAD83_Oklahoma_North = 32124;
  constexpr int PCS_NAD83_Oklahoma_South = 32125;
  constexpr int PCS_NAD83_Oregon_North = 32126;
  constexpr int PCS_NAD83_Oregon_South = 32127;
  constexpr int PCS_NAD83_Pennsylvania_N = 32128;
  constexpr int PCS_NAD83_Pennsylvania_S = 32129;
  constexpr int PCS_NAD83_Rhode_Island = 32130;
  constexpr int PCS_NAD83_South_Carolina = 32133;
  constexpr int PCS_NAD83_South_Dakota_N = 32134;
  constexpr int PCS_NAD83_South_Dakota_S = 32135;
  constexpr int PCS_NAD83_Tennessee = 32136;
  constexpr int PCS_NAD83_Texas_North = 32137;
  constexpr int PCS_NAD83_Texas_North_Central = 32138;
  constexpr int PCS_NAD83_Texas_Central = 32139;
  constexpr int PCS_NAD83_Texas_South_Central = 32140;
  constexpr int PCS_NAD83_Texas_South = 32141;
  constexpr int PCS_NAD83_Utah_North = 32142;
  constexpr int PCS_NAD83_Utah_Central = 32143;
  constexpr int PCS_NAD83_Utah_South = 32144;
  constexpr int PCS_NAD83_Vermont = 32145;
  constexpr int PCS_NAD83_Virginia_North = 32146;
  constexpr int PCS_NAD83_Virginia_South = 32147;
  constexpr int PCS_NAD83_Washington_North = 32148;
  constexpr int PCS_NAD83_Washington_South = 32149;
  constexpr int PCS_NAD83_West_Virginia_N = 32150;
  constexpr int PCS_NAD83_West_Virginia_S = 32151;
  constexpr int PCS_NAD83_Wisconsin_North = 32152;
  constexpr int PCS_NAD83_Wisconsin_Central = 32153;
  constexpr int PCS_NAD83_Wisconsin_South = 32154;
  constexpr int PCS_NAD83_Wyoming_East = 32155;
  constexpr int PCS_NAD83_Wyoming_East_Central = 32156;
  constexpr int PCS_NAD83_Wyoming_West_Central = 32157;
  constexpr int PCS_NAD83_Wyoming_West = 32158;
  constexpr int PCS_NAD83_Puerto_Rico = 32161;
}  // namespace pcs
...
class StatePlaneLCC
{
 public:
  StatePlaneLCC(
      short geokey, const std::string& zone, F64 falseEasting, F64 falseNorthing, F64 latOriginDegree, F64 longMeridianDegree,
      F64 firstStdParallelDegree, F64 secondStdParallelDegree)
      : geokey(geokey),
        zone(zone),
        falseEasting(falseEasting),
        falseNorthing(falseNorthing),
        latOriginDegree(latOriginDegree),
        longMeridianDegree(longMeridianDegree),
        firstStdParallelDegree(firstStdParallelDegree),
        secondStdParallelDegree(secondStdParallelDegree) {
  }
...
static const StatePlaneLCC state_plane_lcc_nad27_list[] =
{
  ...
  StatePlaneLCC(pcs::PCS_NAD27_Alaska_zone_10, "AK_10", 914401.8288, 0, 51, -176, 51.83333333, 53.83333333),
  StatePlaneLCC(pcs::PCS_NAD27_Arkansas_North, "AR_N",609601.2192,0,34.33333333,-92,34.93333333,36.23333333),
  StatePlaneLCC(pcs::PCS_NAD27_Arkansas_South, "AR_S",609601.2192,0,32.66666667,-92,33.3,34.76666667),
  StatePlaneLCC(pcs::PCS_NAD27_California_I, "CA_I",609601.2192,0,39.33333333,-122,40,41.66666667),
  StatePlaneLCC(pcs::PCS_NAD27_California_II, "CA_II",609601.2192,0,37.66666667,-122,38.33333333,39.83333333),
  StatePlaneLCC(pcs::PCS_NAD27_California_III, "CA_III",609601.2192,0,36.5,-120.5,37.06666667,38.43333333),
  StatePlaneLCC(pcs::PCS_NAD27_California_IV, "CA_IV",609601.2192,0,35.33333333,-119,36,37.25),
  StatePlaneLCC(pcs::PCS_NAD27_California_V, "CA_V",609601.2192,0,33.5,-118,34.03333333,35.46666667),
  StatePlaneLCC(pcs::PCS_NAD27_California_VI, "CA_VI",609601.2192,0,32.16666667,-116.25,32.78333333,33.88333333),
  StatePlaneLCC(pcs::PCS_NAD27_California_VII, "CA_VII",1276106.451,1268253.007,34.13333333,-118.3333333,33.86666667,34.41666667),
  StatePlaneLCC(pcs::PCS_NAD27_Colorado_North, "CO_N",609601.2192,0,39.33333333,-105.5,39.71666667,40.78333333),
  StatePlaneLCC(pcs::PCS_NAD27_Colorado_Central, "CO_C",609601.2192,0,37.83333333,-105.5,38.45,39.75),
  StatePlaneLCC(pcs::PCS_NAD27_Colorado_South, "CO_S",609601.2192,0,36.66666667,-105.5,37.23333333,38.43333333),
  StatePlaneLCC(pcs::PCS_NAD27_Connecticut, "CT",182880.3658,0,40.83333333,-72.75,41.2,41.86666667),
  StatePlaneLCC(pcs::PCS_NAD27_Florida_North, "FL_N",609601.2192,0,29,-84.5,29.58333333,30.75),
  StatePlaneLCC(pcs::PCS_NAD27_Iowa_North, "IA_N",609601.2192,0,41.5,-93.5,42.06666667,43.26666667),
  StatePlaneLCC(pcs::PCS_NAD27_Iowa_South, "IA_S",609601.2192,0,40,-93.5,40.61666667,41.78333333),
  StatePlaneLCC(pcs::PCS_NAD27_Kansas_North, "KS_N",609601.2192,0,38.33333333,-98,38.71666667,39.78333333),
  StatePlaneLCC(pcs::PCS_NAD27_Kansas_South, "KS_S",609601.2192,0,36.66666667,-98.5,37.26666667,38.56666667),
  StatePlaneLCC(pcs::PCS_NAD27_Kentucky_North, "KY_N",609601.2192,0,37.5,-84.25,37.96666667,38.96666667),
  StatePlaneLCC(pcs::PCS_NAD27_Kentucky_South, "KY_S",609601.2192,0,36.33333333,-85.75,36.73333333,37.93333333),
  StatePlaneLCC(pcs::PCS_NAD27_Louisiana_North, "LA_N",609601.2192,0,30.66666667,-92.5,31.16666667,32.66666667),
  StatePlaneLCC(pcs::PCS_NAD27_Louisiana_South, "LA_S",609601.2192,0,28.66666667,-91.33333333,29.3,30.7),
  StatePlaneLCC(pcs::PCS_NAD27_Maryland, "MD",243840.4877,0,37.83333333,-77,38.3,39.45),
  StatePlaneLCC(pcs::PCS_NAD27_Massachusetts, "MA_M",182880.3658,0,41,-71.5,41.71666667,42.68333333),
  StatePlaneLCC(pcs::PCS_NAD27_Massachusetts_Is, "MA_I",60960.12192,0,41,-70.5,41.28333333,41.48333333),
  StatePlaneLCC(pcs::PCS_NAD27_Michigan_North, "MI_N",609601.2192,0,44.78333333,-87,45.48333333,47.08333333),
  StatePlaneLCC(pcs::PCS_NAD27_Michigan_Central, "MI_C",609601.2192,0,43.31666667,-84.33333333,44.18333333,45.7),
  StatePlaneLCC(pcs::PCS_NAD27_Michigan_South, "MI_S",609601.2192,0,41.5,-84.33333333,42.1,43.66666667),
  StatePlaneLCC(pcs::PCS_NAD27_Minnesota_North, "MN_N",609601.2192,0,46.5,-93.1,47.03333333,48.63333333),
  StatePlaneLCC(pcs::PCS_NAD27_Minnesota_Central, "MN_C",609601.2192,0,45,-94.25,45.61666667,47.05),
  StatePlaneLCC(pcs::PCS_NAD27_Minnesota_South, "MN_S",609601.2192,0,43,-94,43.78333333,45.21666667),
  StatePlaneLCC(pcs::PCS_NAD27_Montana_North, "MT_N",609601.2192,0,47,-109.5,47.85,48.71666667),
  StatePlaneLCC(pcs::PCS_NAD27_Montana_Central, "MT_C",609601.2192,0,45.83333333,-109.5,46.45,47.88333333),
  StatePlaneLCC(pcs::PCS_NAD27_Montana_South, "MT_S",609601.2192,0,44,-109.5,44.86666667,46.4),
  StatePlaneLCC(pcs::PCS_NAD27_Nebraska_North, "NE_N",609601.2192,0,41.33333333,-100,41.85,42.81666667),
  StatePlaneLCC(pcs::PCS_NAD27_Nebraska_South, "NE_S",609601.2192,0,39.66666667,-99.5,40.28333333,41.71666667),
  StatePlaneLCC(pcs::PCS_NAD27_New_York_Long_Is, "NY_LI",609601.2192,30480.06096,40.5,-74,40.66666667,41.03333333),
  StatePlaneLCC(pcs::PCS_NAD27_North_Carolina, "NC",609601.2192,0,33.75,-79,34.33333333,36.16666667),
  StatePlaneLCC(pcs::PCS_NAD27_North_Dakota_N, "ND_N",609601.2192,0,47,-100.5,47.43333333,48.73333333),
  StatePlaneLCC(pcs::PCS_NAD27_North_Dakota_S, "ND_S",609601.2192,0,45.66666667,-100.5,46.18333333,47.48333333),
  StatePlaneLCC(pcs::PCS_NAD27_Ohio_North, "OH_N",609601.2192,0,39.66666667,-82.5,40.43333333,41.7),
  StatePlaneLCC(pcs::PCS_NAD27_Ohio_South, "OH_S",609601.2192,0,38,-82.5,38.73333333,40.03333333),
  StatePlaneLCC(pcs::PCS_NAD27_Oklahoma_North, "OK_N",609601.2192,0,35,-98,35.56666667,36.76666667),
  StatePlaneLCC(pcs::PCS_NAD27_Oklahoma_South, "OK_S",609601.2192,0,33.33333333,-98,33.93333333,35.23333333),
  StatePlaneLCC(pcs::PCS_NAD27_Oregon_North, "OR_N",609601.2192,0,43.66666667,-120.5,44.33333333,46),
  StatePlaneLCC(pcs::PCS_NAD27_Oregon_South, "OR_S",609601.2192,0,41.66666667,-120.5,42.33333333,44),
  StatePlaneLCC(pcs::PCS_NAD27_Pennsylvania_N, "PA_N",609601.2192,0,40.16666667,-77.75,40.88333333,41.95),
  StatePlaneLCC(pcs::PCS_NAD27_Pennsylvania_S, "PA_S",609601.2192,0,39.33333333,-77.75,39.93333333,40.96666667),
  StatePlaneLCC(pcs::PCS_NAD27_Puerto_Rico, "PR",152400.3048,0,17.83333333,-66.43333333,18.03333333,18.43333333),
  StatePlaneLCC(pcs::PCS_NAD27_St_Croix, "St.Croix",152400.3048,30480.06096,17.83333333,-66.43333333,18.03333333,18.43333333),
  StatePlaneLCC(pcs::PCS_NAD27_South_Carolina_N, "SC_N",609601.2192,0,33,-81,33.76666667,34.96666667),
  StatePlaneLCC(pcs::PCS_NAD27_South_Carolina_S, "SC_S",609601.2192,0,31.83333333,-81,32.33333333,33.66666667),
  StatePlaneLCC(pcs::PCS_NAD27_South_Dakota_N, "SD_N",609601.2192,0,43.83333333,-100,44.41666667,45.68333333),
  StatePlaneLCC(pcs::PCS_NAD27_South_Dakota_S, "SD_S",609601.2192,0,42.33333333,-100.3333333,42.83333333,44.4),
  StatePlaneLCC(pcs::PCS_NAD27_Tennessee, "TN",609601.2192,30480.06096,34.66666667,-86,35.25,36.41666667),
  StatePlaneLCC(pcs::PCS_NAD27_Texas_North, "TX_N",609601.2192,0,34,-101.5,34.65,36.18333333),
  StatePlaneLCC(pcs::PCS_NAD27_Texas_North_Central, "TX_NC",609601.2192,0,31.66666667,-97.5,32.13333333,33.96666667),
  StatePlaneLCC(pcs::PCS_NAD27_Texas_Central, "TX_C",609601.2192,0,29.66666667,-100.3333333,30.11666667,31.88333333),
  StatePlaneLCC(pcs::PCS_NAD27_Texas_South_Central, "TX_SC",609601.2192,0,27.83333333,-99,28.38333333,30.28333333),
  StatePlaneLCC(pcs::PCS_NAD27_Texas_South, "TX_S",609601.2192,0,25.66666667,-98.5,26.16666667,27.83333333),
  StatePlaneLCC(pcs::PCS_NAD27_Utah_North, "UT_N",609601.2192,0,40.33333333,-111.5,40.71666667,41.78333333),
  StatePlaneLCC(pcs::PCS_NAD27_Utah_Central, "UT_C",609601.2192,0,38.33333333,-111.5,39.01666667,40.65),
  StatePlaneLCC(pcs::PCS_NAD27_Utah_South, "UT_S",609601.2192,0,36.66666667,-111.5,37.21666667,38.35),
  StatePlaneLCC(pcs::PCS_NAD27_Virginia_North, "VA_N",609601.2192,0,37.66666667,-78.5,38.03333333,39.2),
  StatePlaneLCC(pcs::PCS_NAD27_Virginia_South, "VA_S",609601.2192,0,36.33333333,-78.5,36.76666667,37.96666667),
  StatePlaneLCC(pcs::PCS_NAD27_Washington_North, "WA_N",609601.2192,0,47,-120.8333333,47.5,48.73333333),
  StatePlaneLCC(pcs::PCS_NAD27_Washington_South, "WA_S",609601.2192,0,45.33333333,-120.5,45.83333333,47.33333333),
  StatePlaneLCC(pcs::PCS_NAD27_West_Virginia_N, "WV_N",609601.2192,0,38.5,-79.5,39,40.25),
  StatePlaneLCC(pcs::PCS_NAD27_West_Virginia_S, "WV_S",609601.2192,0,37,-81,37.48333333,38.88333333),
  StatePlaneLCC(pcs::PCS_NAD27_Wisconsin_North, "WI_N",609601.2192,0,45.16666667,-90,45.56666667,46.76666667),
  StatePlaneLCC(pcs::PCS_NAD27_Wisconsin_Central, "WI_C",609601.2192,0,43.83333333,-90,44.25,45.5),
  StatePlaneLCC(pcs::PCS_NAD27_Wisconsin_South, "WI_S",609601.2192,0,42,-90,42.73333333,44.06666667),
...
static const StatePlaneLCC state_plane_lcc_nad83_list[] =
{
  ...
  StatePlaneLCC(pcs::PCS_NAD83_Alaska_zone_10, "AK_10",1000000,0,51.000000,-176.000000,51.833333,53.833333),
  StatePlaneLCC(pcs::PCS_NAD83_Arkansas_North, "AR_N",400000,0,34.333333,-92.000000,34.933333,36.233333),
  StatePlaneLCC(pcs::PCS_NAD83_Arkansas_South, "AR_S",400000,400000,32.666667,-92.000000,33.300000,34.766667),
  StatePlaneLCC(pcs::PCS_NAD83_California_1, "CA_I",2000000,500000,39.333333,-122.000000,40.000000,41.666667),
  StatePlaneLCC(pcs::PCS_NAD83_California_2, "CA_II",2000000,500000,37.666667,-122.000000,38.333333,39.833333),
  StatePlaneLCC(pcs::PCS_NAD83_California_3, "CA_III",2000000,500000,36.500000,-120.500000,37.066667,38.433333),
  StatePlaneLCC(pcs::PCS_NAD83_California_4, "CA_IV",2000000,500000,35.333333,-119.000000,36.000000,37.250000),
  StatePlaneLCC(pcs::PCS_NAD83_California_5, "CA_V",2000000,500000,33.500000,-118.000000,34.033333,35.466667),
  StatePlaneLCC(pcs::PCS_NAD83_California_6, "CA_VI",2000000,500000,32.166667,-116.250000,32.783333,33.883333),
  StatePlaneLCC(pcs::PCS_NAD83_Colorado_North, "CO_N",914401.8289,304800.6096,39.333333,-105.500000,39.716667,40.783333),
  StatePlaneLCC(pcs::PCS_NAD83_Colorado_Central, "CO_C",914401.8289,304800.6096,37.833333,-105.500000,38.450000,39.750000),
  StatePlaneLCC(pcs::PCS_NAD83_Colorado_South, "CO_S",914401.8289,304800.6096,36.666667,-105.500000,37.233333,38.433333),
  StatePlaneLCC(pcs::PCS_NAD83_Connecticut, "CT",304800.6096,152400.3048,40.833333,-72.750000,41.200000,41.866667),
  StatePlaneLCC(pcs::PCS_NAD83_Florida_North, "FL_N",600000,0,29.000000,-84.500000,29.583333,30.750000),
  StatePlaneLCC(pcs::PCS_NAD83_Iowa_North, "IA_N",1500000,1000000,41.500000,-93.500000,42.066667,43.266667),
  StatePlaneLCC(pcs::PCS_NAD83_Iowa_South, "IA_S",500000,0,40.000000,-93.500000,40.616667,41.783333),
  StatePlaneLCC(pcs::PCS_NAD83_Kansas_North, "KS_N",400000,0,38.333333,-98.000000,38.716667,39.783333),
  StatePlaneLCC(pcs::PCS_NAD83_Kansas_South, "KS_S",400000,400000,36.666667,-98.500000,37.266667,38.566667),
  StatePlaneLCC(pcs::PCS_NAD83_Kentucky_North, "KY_N",500000,0,37.500000,-84.250000,37.966667,38.966667),
  StatePlaneLCC(pcs::PCS_NAD83_Kentucky_South, "KY_S",500000,500000,36.333333,-85.750000,36.733333,37.933333),
  StatePlaneLCC(pcs::PCS_NAD83_Louisiana_North, "LA_N",1000000,0,30.500000,-92.500000,31.166667,32.666667),
  StatePlaneLCC(pcs::PCS_NAD83_Louisiana_South, "LA_S",1000000,0,28.500000,-91.333333,29.300000,30.700000),
  StatePlaneLCC(pcs::PCS_NAD83_Maryland, "MD",400000,0,37.666667,-77.000000,38.300000,39.450000),
  StatePlaneLCC(pcs::PCS_NAD83_Massachusetts, "MA_M",200000,750000,41.000000,-71.500000,41.716667,42.683333),
  StatePlaneLCC(pcs::PCS_NAD83_Massachusetts_Is, "MA_I",500000,0,41.000000,-70.500000,41.283333,41.483333),
  StatePlaneLCC(pcs::PCS_NAD83_Michigan_North, "MI_N",8000000,0,44.783333,-87.000000,45.483333,47.083333),
  StatePlaneLCC(pcs::PCS_NAD83_Michigan_Central, "MI_C",6000000,0,43.316667,-84.366667,44.183333,45.700000),
  StatePlaneLCC(pcs::PCS_NAD83_Michigan_South, "MI_S",4000000,0,41.500000,-84.366667,42.100000,43.666667),
  StatePlaneLCC(pcs::PCS_NAD83_Minnesota_North, "MN_N",800000,100000,46.500000,-93.100000,47.033333,48.633333),
  StatePlaneLCC(pcs::PCS_NAD83_Minnesota_Central, "MN_C",800000,100000,45.000000,-94.250000,45.616667,47.050000),
  StatePlaneLCC(pcs::PCS_NAD83_Minnesota_South, "MN_S",800000,100000,43.000000,-94.000000,43.783333,45.216667),
  StatePlaneLCC(pcs::PCS_NAD83_Montana, "MT",600000,0,44.250000,-109.500000,45.000000,49.000000),
  StatePlaneLCC(pcs::PCS_NAD83_Nebraska, "NE",500000,0,39.833333,-100.000000,40.000000,43.000000),
  StatePlaneLCC(pcs::PCS_NAD83_New_York_Long_Is, "NY_LI",300000,0,40.166667,-74.000000,40.666667,41.033333),
  StatePlaneLCC(pcs::PCS_NAD83_North_Carolina, "NC",609601.22,0,33.750000,-79.000000,34.333333,36.166667),
  StatePlaneLCC(pcs::PCS_NAD83_North_Dakota_N, "ND_N",600000,0,47.000000,-100.500000,47.433333,48.733333),
  StatePlaneLCC(pcs::PCS_NAD83_North_Dakota_S, "ND_S",600000,0,45.666667,-100.500000,46.183333,47.483333),
  StatePlaneLCC(pcs::PCS_NAD83_Ohio_North, "OH_N",600000,0,39.666667,-82.500000,40.433333,41.700000),
  StatePlaneLCC(pcs::PCS_NAD83_Ohio_South, "OH_S",600000,0,38.000000,-82.500000,38.733333,40.033333),
  StatePlaneLCC(pcs::PCS_NAD83_Oklahoma_North, "OK_N",600000,0,35.000000,-98.000000,35.566667,36.766667),
  StatePlaneLCC(pcs::PCS_NAD83_Oklahoma_South, "OK_S",600000,0,33.333333,-98.000000,33.933333,35.233333),
  StatePlaneLCC(pcs::PCS_NAD83_Oregon_North, "OR_N",2500000,0,43.666667,-120.500000,44.333333,46.000000),
  StatePlaneLCC(pcs::PCS_NAD83_Oregon_South, "OR_S",1500000,0,41.666667,-120.500000,42.333333,44.000000),
  StatePlaneLCC(pcs::PCS_NAD83_Pennsylvania_N, "PA_N",600000,0,40.166667,-77.750000,40.883333,41.950000),
  StatePlaneLCC(pcs::PCS_NAD83_Pennsylvania_S, "PA_S",600000,0,39.333333,-77.750000,39.933333,40.966667),
  StatePlaneLCC(pcs::PCS_NAD83_Puerto_Rico, "PR",200000,200000,17.833333,-66.433333,18.033333,18.433333),
  StatePlaneLCC(pcs::PCS_NAD83_South_Carolina, "SC",609600,0,31.833333,-81.000000,32.500000,34.833333),
  StatePlaneLCC(pcs::PCS_NAD83_South_Dakota_N, "SD_N",600000,0,43.833333,-100.000000,44.416667,45.683333),
  StatePlaneLCC(pcs::PCS_NAD83_South_Dakota_S, "SD_S",600000,0,42.333333,-100.333333,42.833333,44.400000),
  StatePlaneLCC(pcs::PCS_NAD83_Tennessee, "TN",600000,0,34.333333,-86.000000,35.250000,36.416667),
  StatePlaneLCC(pcs::PCS_NAD83_Texas_North, "TX_N",200000,1000000,34.000000,-101.500000,34.650000,36.183333),
  StatePlaneLCC(pcs::PCS_NAD83_Texas_North_Central, "TX_NC",600000,2000000,31.666667,-98.500000,32.133333,33.966667),
  StatePlaneLCC(pcs::PCS_NAD83_Texas_Central, "TX_C",700000,3000000,29.666667,-100.333333,30.116667,31.883333),
  StatePlaneLCC(pcs::PCS_NAD83_Texas_South_Central, "TX_SC",600000,4000000,27.833333,-99.000000,28.383333,30.283333),
  StatePlaneLCC(pcs::PCS_NAD83_Texas_South, "TX_S",300000,5000000,25.666667,-98.500000,26.166667,27.833333),
  StatePlaneLCC(pcs::PCS_NAD83_Utah_North, "UT_N",500000,1000000,40.333333,-111.500000,40.716667,41.783333),
  StatePlaneLCC(pcs::PCS_NAD83_Utah_Central, "UT_C",500000,2000000,38.333333,-111.500000,39.016667,40.650000),
  StatePlaneLCC(pcs::PCS_NAD83_Utah_South, "UT_S",500000,3000000,36.666667,-111.500000,37.216667,38.350000),
  StatePlaneLCC(pcs::PCS_NAD83_Virginia_North, "VA_N",3500000,2000000,37.666667,-78.500000,38.033333,39.200000),
  StatePlaneLCC(pcs::PCS_NAD83_Virginia_South, "VA_S",3500000,1000000,36.333333,-78.500000,36.766667,37.966667),
  StatePlaneLCC(pcs::PCS_NAD83_Washington_North, "WA_N",500000,0,47.000000,-120.833333,47.500000,48.733333),
  StatePlaneLCC(pcs::PCS_NAD83_Washington_South, "WA_S",500000,0,45.333333,-120.500000,45.833333,47.333333),
  StatePlaneLCC(pcs::PCS_NAD83_West_Virginia_N, "WV_N",600000,0,38.500000,-79.500000,39.000000,40.250000),
  StatePlaneLCC(pcs::PCS_NAD83_West_Virginia_S, "WV_S",600000,0,37.000000,-81.000000,37.483333,38.883333),
  StatePlaneLCC(pcs::PCS_NAD83_Wisconsin_North, "WI_N",600000,0,45.166667,-90.000000,45.566667,46.766667),
  StatePlaneLCC(pcs::PCS_NAD83_Wisconsin_Central, "WI_C",600000,0,43.833333,-90.000000,44.250000,45.500000),
  StatePlaneLCC(pcs::PCS_NAD83_Wisconsin_South, "WI_S",600000,0,42.000000,-90.000000,42.733333,44.066667),
  StatePlaneLCC(0,"",-1,-1,-1,-1,-1,-1)
};
...
class StatePlaneTM {
 public:
  StatePlaneTM(
      short geokey, const std::string& zone, F64 falseEasting, F64 falseNorthing, F64 latOriginDegree, F64 longMeridianDegree, F64 scaleFactor)
      : geokey(geokey),
        zone(zone),
        falseEasting(falseEasting),
        falseNorthing(falseNorthing),
...
static const StatePlaneTM state_plane_tm_nad27_list[] =
{
  ...
  StatePlaneTM(pcs::PCS_NAD27_Alabama_East, "AL_E",152400.3048,0,30.5,-85.83333333,0.99996),
  StatePlaneTM(pcs::PCS_NAD27_Alabama_West, "AL_W",152400.3048,0,30,-87.5,0.999933333),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_2, "AK_2",152400.3048,0,54,-142,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_3, "AK_3",152400.3048,0,54,-146,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_4, "AK_4",152400.3048,0,54,-150,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_5, "AK_5",152400.3048,0,54,-154,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_6, "AK_6",152400.3048,0,54,-158,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_7, "AK_7",213360.4267,0,54,-162,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_8, "AK_8",152400.3048,0,54,-166,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Alaska_zone_9, "AK_9",182880.3658,0,54,-170,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Arizona_East, "AZ_E",152400.3048,0,31,-110.1666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Arizona_Central, "AZ_C",152400.3048,0,31,-111.9166667,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Arizona_West, "AZ_W",152400.3048,0,31,-113.75,0.999933333),
  StatePlaneTM(pcs::PCS_NAD27_Delaware, "DE",152400.3048,0,38,-75.41666667,0.999995),
  StatePlaneTM(pcs::PCS_NAD27_Florida_East, "FL_E",152400.3048,0,24.33333333,-81,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Florida_West, "FL_W",152400.3048,0,24.33333333,-82,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Georgia_East, "GA_E",152400.3048,0,30,-82.16666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Georgia_West, "GA_W",152400.3048,0,30,-84.16666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Hawaii_zone_1, "HI_1",152400.3048,0,18.83333333,-155.5,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_Hawaii_zone_2, "HI_2",152400.3048,0,20.33333333,-156.6666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_Hawaii_zone_3, "HI_3",152400.3048,0,21.16666667,-158,0.99999),
  StatePlaneTM(pcs::PCS_NAD27_Hawaii_zone_4, "HI_4",152400.3048,0,21.83333333,-159.5,0.99999),
  StatePlaneTM(pcs::PCS_NAD27_Hawaii_zone_5, "HI_5",152400.3048,0,21.66666667,-160.1666667,1),
  StatePlaneTM(pcs::PCS_NAD27_Idaho_East, "ID_E",152400.3048,0,41.66666667,-112.1666667,0.999947368),
  StatePlaneTM(pcs::PCS_NAD27_Idaho_Central, "ID_C",152400.3048,0,41.66666667,-114,0.999947368),
  StatePlaneTM(pcs::PCS_NAD27_Idaho_West, "ID_W",152400.3048,0,41.66666667,-115.75,0.999933333),
  StatePlaneTM(pcs::PCS_NAD27_Illinois_East, "IL_E",152400.3048,0,36.66666667,-88.33333333,0.999975),
  StatePlaneTM(pcs::PCS_NAD27_Illinois_West, "IL_W",152400.3048,0,36.66666667,-90.16666667,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Indiana_East, "IN_E",152400.3048,0,37.5,-85.66666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_Indiana_West, "IN_W",152400.3048,0,37.5,-87.08333333,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_Maine_East, "ME_E",152400.3048,0,43.83333333,-68.5,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Maine_West, "ME_W",152400.3048,0,42.83333333,-70.16666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_Mississippi_East, "MS_E",152400.3048,0,29.66666667,-88.83333333,0.99996),
  StatePlaneTM(pcs::PCS_NAD27_Mississippi_West, "MS_W",152400.3048,0,30.5,-90.33333333,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Missouri_East, "MO_E",152400.3048,0,35.83333333,-90.5,0.999933333),
  StatePlaneTM(pcs::PCS_NAD27_Missouri_Central, "MO_C",152400.3048,0,35.83333333,-92.5,0.999933333),
  StatePlaneTM(pcs::PCS_NAD27_Missouri_West, "MO_W",152400.3048,0,36.16666667,-94.5,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Nevada_East, "NV_E",152400.3048,0,34.75,-115.5833333,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Nevada_Central, "NV_C",152400.3048,0,34.75,-116.6666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_Nevada_West, "NV_W",152400.3048,0,34.75,-118.5833333,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_New_Hampshire, "NH",152400.3048,0,42.5,-71.66666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_New_Jersey, "NJ",609601.2192,0,38.83333333,-74.66666667,0.999975),
  StatePlaneTM(pcs::PCS_NAD27_New_Mexico_East, "NM_E",152400.3048,0,31,-104.3333333,0.999909091),
  StatePlaneTM(pcs::PCS_NAD27_New_Mexico_Central, "NM_C",152400.3048,0,31,-106.25,0.9999),
  StatePlaneTM(pcs::PCS_NAD27_New_Mexico_West, "NM_W",152400.3048,0,31,-107.8333333,0.999916667),
  StatePlaneTM(pcs::PCS_NAD27_New_York_East, "NY_E",152400.3048,0,40,-74.33333333,0.999966667),
  StatePlaneTM(pcs::PCS_NAD27_New_York_Central, "NY_C",152400.3048,0,40,-76.58333333,0.9999375),
  StatePlaneTM(pcs::PCS_NAD27_New_York_West, "NY_W",152400.3048,0,40,-78.58333333,0.9999375),
  StatePlaneTM(pcs::PCS_NAD27_Rhode_Island, "RI",152400.3048,0,41.08333333,-71.5,0.99999375),
  StatePlaneTM(pcs::PCS_NAD27_Vermont, "VT",152400.3048,0,42.5,-72.5,0.999964286),
  StatePlaneTM(pcs::PCS_NAD27_Wyoming_East, "WY_E",152400.3048,0,40.66666667,-105.1666667,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Wyoming_East_Central, "WY_EC",152400.3048,0,40.66666667,-107.3333333,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Wyoming_West_Central, "WY_WC",152400.3048,0,40.66666667,-108.75,0.999941177),
  StatePlaneTM(pcs::PCS_NAD27_Wyoming_West, "WY_W",152400.3048,0,40.66666667,-110.0833333,0.999941177),
    StatePlaneTM(0, "", -1, -1, -1, -1, -1)};

static const StatePlaneTM state_plane_tm_nad83_list[] =
{
  // geotiff key, zone, false east [m], false north [m], ProjOrig(Lat), CentMerid(Long), scale factor
  StatePlaneTM(pcs::PCS_NAD83_Alabama_East, "AL_E",200000,0,30.5,-85.83333333,0.99996),
  StatePlaneTM(pcs::PCS_NAD83_Alabama_West, "AL_W",600000,0,30,-87.5,0.999933333),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_2, "AK_2",500000,0,54,-142,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_3, "AK_3",500000,0,54,-146,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_4, "AK_4",500000,0,54,-150,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_5, "AK_5",500000,0,54,-154,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_6, "AK_6",500000,0,54,-158,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_7, "AK_7",500000,0,54,-162,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_8, "AK_8",500000,0,54,-166,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Alaska_zone_9, "AK_9",500000,0,54,-170,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Arizona_East, "AZ_E",213360,0,31,-110.1666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Arizona_Central, "AZ_C",213360,0,31,-111.9166667,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Arizona_West, "AZ_W",213360,0,31,-113.75,0.999933333),
  StatePlaneTM(pcs::PCS_NAD83_Delaware, "DE",200000,0,38,-75.41666667,0.999995),
  StatePlaneTM(pcs::PCS_NAD83_Florida_East, "FL_E",200000,0,24.33333333,-81,0.999941177),
  StatePlaneTM(pcs::PCS_NAD83_Florida_West, "FL_W",200000,0,24.33333333,-82,0.999941177),
  StatePlaneTM(pcs::PCS_NAD83_Georgia_East, "GA_E",200000,0,30,-82.16666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Georgia_West, "GA_W",700000,0,30,-84.16666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Hawaii_zone_1, "HI_1",500000,0,18.83333333,-155.5,0.999966667),
  StatePlaneTM(pcs::PCS_NAD83_Hawaii_zone_2, "HI_2",500000,0,20.33333333,-156.6666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD83_Hawaii_zone_3, "HI_3",500000,0,21.16666667,-158,0.99999),
  StatePlaneTM(pcs::PCS_NAD83_Hawaii_zone_4, "HI_4",500000,0,21.83333333,-159.5,0.99999),
  StatePlaneTM(pcs::PCS_NAD83_Hawaii_zone_5, "HI_5",500000,0,21.66666667,-160.1666667,1),
  StatePlaneTM(pcs::PCS_NAD83_Idaho_East, "ID_E",200000,0,41.66666667,-112.1666667,0.999947368),
  StatePlaneTM(pcs::PCS_NAD83_Idaho_Central, "ID_C",500000,0,41.66666667,-114,0.999947368),
  StatePlaneTM(pcs::PCS_NAD83_Idaho_West, "ID_W",800000,0,41.66666667,-115.75,0.999933333),
  StatePlaneTM(pcs::PCS_NAD83_Illinois_East, "IL_E",300000,0,36.66666667,-88.33333333,0.999975),
  StatePlaneTM(pcs::PCS_NAD83_Illinois_West, "IL_W",700000,0,36.66666667,-90.16666667,0.999941177),
  StatePlaneTM(pcs::PCS_NAD83_Indiana_East, "IN_E",100000,250000,37.5,-85.66666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD83_Indiana_West, "IN_W",900000,250000,37.5,-87.08333333,0.999966667),
  StatePlaneTM(pcs::PCS_NAD83_Maine_East, "ME_E",300000,0,43.66666667,-68.5,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Maine_West, "ME_W",900000,0,42.83333333,-70.16666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD83_Mississippi_East, "MS_E",300000,0,29.5,-88.83333333,0.99995),
  StatePlaneTM(pcs::PCS_NAD83_Mississippi_West, "MS_W",700000,0,29.5,-90.33333333,0.99995),
  StatePlaneTM(pcs::PCS_NAD83_Missouri_East, "MO_E",250000,0,35.83333333,-90.5,0.999933333),
  StatePlaneTM(pcs::PCS_NAD83_Missouri_Central, "MO_C",500000,0,35.83333333,-92.5,0.999933333),
  StatePlaneTM(pcs::PCS_NAD83_Missouri_West, "MO_W",850000,0,36.16666667,-94.5,0.999941177),
  StatePlaneTM(pcs::PCS_NAD83_Nevada_East, "NV_E",200000,8000000,34.75,-115.5833333,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Nevada_Central, "NV_C",500000,6000000,34.75,-116.6666667,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_Nevada_West, "NV_W",800000,4000000,34.75,-118.5833333,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_New_Hampshire, "NH",300000,0,42.5,-71.66666667,0.999966667),
  StatePlaneTM(pcs::PCS_NAD83_New_Jersey, "NJ",150000,0,38.83333333,-74.5,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_New_Mexico_East, "NM_E",165000,0,31,-104.3333333,0.999909091),
  StatePlaneTM(pcs::PCS_NAD83_New_Mexico_Central, "NM_C",500000,0,31,-106.25,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_New_Mexico_West, "NM_W",830000,0,31,-107.8333333,0.999916667),
  StatePlaneTM(pcs::PCS_NAD83_New_York_East, "NY_E",150000,0,38.83333333,-74.5,0.9999),
  StatePlaneTM(pcs::PCS_NAD83_New_York_Central, "NY_C",250000,0,40,-76.58333333,0.9999375),
  StatePlaneTM(pcs::PCS_NAD83_New_York_West, "NY_W",350000,0,40,-78.58333333,0.9999375),
  StatePlaneTM(pcs::PCS_NAD83_Rhode_Island, "RI",100000,0,41.08333333,-71.5,0.99999375),
  StatePlaneTM(pcs::PCS_NAD83_Vermont, "VT",500000,0,42.5,-72.5,0.999964286),
  StatePlaneTM(pcs::PCS_NAD83_Wyoming_East, "WY_E",200000,0,40.5,-105.1666667,0.9999375),
  StatePlaneTM(pcs::PCS_NAD83_Wyoming_East_Central, "WY_EC",400000,100000,40.5,-107.3333333,0.9999375),
  StatePlaneTM(pcs::PCS_NAD83_Wyoming_West_Central, "WY_WC",600000,0,40.5,-108.75,0.9999375),
  StatePlaneTM(pcs::PCS_NAD83_Wyoming_West, "WY_W",800000,100000,40.5,-110.0833333,0.9999375),
  StatePlaneTM(0,"",-1,-1,-1,-1,-1)
};
...
BOOL CRScheck::set_ellipsoid(const I32 ellipsoid_id, const BOOL from_geokeys, std::string* description)
{
  ...
  if (description)
  {
    *description = std::to_string(ellipsoid->id) + " - " + ellipsoid->name + " (" + std::to_string(ellipsoid->equatorial_radius) + " " +
                   std::to_string(ellipsoid->eccentricity_squared) + ")";
  }
...
BOOL CRScheck::set_no_projection(const BOOL from_geokeys, std::string* description) {
  CRSprojectionParameters* no = new CRSprojectionParameters();
  no->type = crs::CRS_PROJECTION_NONE;
  no->name = "intentionally no projection";
...
BOOL CRScheck::set_latlong_projection(const BOOL from_geokeys, std::string* description) {
  CRSprojectionParameters* latlong = new CRSprojectionParameters();
  latlong->type = crs::CRS_PROJECTION_LAT_LONG;
  latlong->name = "latitude/longitude";
  set_projection(latlong, from_geokeys);
  if (description) {
    *description = latlong->name;
  }
  return TRUE;
}

BOOL CRScheck::set_longlat_projection(const BOOL from_geokeys, std::string* description) {
  CRSprojectionParameters* longlat = new CRSprojectionParameters();
  longlat->type = crs::CRS_PROJECTION_LONG_LAT;
  longlat->name = "longitude/latitude";
  set_projection(longlat, from_geokeys);
  if (description) {
    *description = longlat->name;
  }
  return TRUE;
}

BOOL CRScheck::set_ecef_projection(const BOOL from_geokeys, std::string* description) {
  CRSprojectionParameters* ecef = new CRSprojectionParameters();
  ecef->type = crs::CRS_PROJECTION_ECEF;
  ecef->name = "ECEF";
  set_projection(ecef, from_geokeys);
  if (description) {
    *description = ecef->name;
  }
  return TRUE;
}

BOOL CRScheck::set_utm_projection(const std::string& zone, const BOOL from_geokeys, std::string* description) {
  size_t i = 0;
  while (i < zone.size() && std::isdigit(zone[i])) ++i;

  int zone_number = std::stoi(zone.substr(0, i));
  std::string zone_letter_str = zone.substr(i);
  char zone_letter = zone_letter_str.empty() ? '\0' : zone_letter_str[0];
  ...
  utm->type = crs::CRS_PROJECTION_UTM;
  ...
  utm->name = "UTM zone " + zone + " (" + (utm->utm_northern_hemisphere ? "northern hemisphere" : "southern hemisphere") + ")";
  utm->utm_long_origin = (zone_number - 1) * 6 - 180 + 3; // + 3 puts origin in middle of zone
  set_projection(utm, from_geokeys);
  if (description) {
    *description = "UTM " + std::to_string(zone_number) + " " + (utm->utm_northern_hemisphere ? "northern hemisphere" : "southern hemisphere");
  }
  return TRUE;
}

BOOL CRScheck::set_utm_projection(const I32 zone_number, const BOOL northern, const BOOL from_geokeys, std::string* description) { 
  if ((zone_number < 0) || (zone_number > 60))
  {
    return FALSE;
  }
...
BOOL CRScheck::set_mga_projection(const I32 zone_number, const BOOL northern, const BOOL from_geokeys, std::string* description) {
  if ((zone_number < 0) || (zone_number > 60))
  {
    return FALSE;
  }
  ...
  utm->utm_zone_letter = ' ';
  utm->utm_northern_hemisphere = northern;
  utm->name = "MGA zone " + std::to_string(zone_number) + " (" + (utm->utm_northern_hemisphere ? "northern hemisphere" : "southern hemisphere") + ")";
  utm->utm_long_origin = (zone_number - 1) * 6 - 180 + 3;  // + 3 puts origin in middle of zone
  set_projection(utm, from_geokeys);
  if (description) {
    *description = "MGA " + std::to_string(zone_number) + (utm->utm_northern_hemisphere ? " northern hemisphere" : " southern hemisphere");
  }
  return TRUE;
}
...
void CRScheck::set_lambert_conformal_conic_projection(
    const F64 falseEasting, const F64 falseNorthing, const F64 latOriginDegree, const F64 longMeridianDegree, const F64 firstStdParallelDegree,
    const F64 secondStdParallelDegree, const BOOL from_geokeys, std::string* description) {
  CRSprojectionParametersLCC* lcc = new CRSprojectionParametersLCC();
  lcc->type = crs::CRS_PROJECTION_LCC;
  lcc->name = "Lambert Conformal Conic";
  ...
  lcc->lcc_lat_origin_radian = crs::deg2rad * lcc->lcc_lat_origin_degree;
  lcc->lcc_long_meridian_radian = crs::deg2rad * lcc->lcc_long_meridian_degree;
  lcc->lcc_first_std_parallel_radian = crs::deg2rad * lcc->lcc_first_std_parallel_degree;
  lcc->lcc_second_std_parallel_radian = crs::deg2rad * lcc->lcc_second_std_parallel_degree;
  set_projection(lcc, from_geokeys);
  if (description) {
    *description = "false east/north: " + std::to_string(lcc->lcc_false_easting_meter) + "/" + std::to_string(lcc->lcc_false_northing_meter) +
                  " [m], origin lat/meridian long: " + std::to_string(lcc->lcc_lat_origin_degree) + "/" +
                  std::to_string(lcc->lcc_long_meridian_degree) + ", parallel 1st/2nd: " + std::to_string(lcc->lcc_first_std_parallel_degree) + "/" +
                  std::to_string(lcc->lcc_second_std_parallel_degree);
  }
}
...
*/
void CRScheck::set_transverse_mercator_projection(
    const F64 falseEasting, const F64 falseNorthing, const F64 latOriginDegree, const F64 longMeridianDegree, const F64 scaleFactor,
    const BOOL from_geokeys, std::string* description) {
  CRSprojectionParametersTM* tm = new CRSprojectionParametersTM();
  tm->type = crs::CRS_PROJECTION_TM;
  tm->name = "Transverse Mercator";
  ...
  tm->tm_lat_origin_radian = crs::deg2rad * tm->tm_lat_origin_degree;
  tm->tm_long_meridian_radian = crs::deg2rad * tm->tm_long_meridian_degree;
  set_projection(tm, from_geokeys);
  if (description) {
    *description = "false east/north: " + std::to_string(tm->tm_false_easting_meter) + "/" + std::to_string(tm->tm_false_northing_meter) +
                   " [m], origin lat/meridian long: " + std::to_string(tm->tm_lat_origin_degree) + "/" + std::to_string(tm->tm_long_meridian_degree) +
                   ", scale: " + std::to_string(tm->tm_scale_factor);
  }
}

BOOL CRScheck::set_state_plane_nad27_lcc(const std::string& zone, const BOOL from_geokeys, std::string& description) {
  constexpr size_t state_plane_lcc_nad27_count = sizeof(state_plane_lcc_nad27_list) / sizeof(state_plane_lcc_nad27_list[0]);

  for (size_t i = 0; i < state_plane_lcc_nad27_count; ++i) {
    if (zone == state_plane_lcc_nad27_list[i].zone) {
      set_ellipsoid(crs::CRS_ELLIPSOID_NAD27, from_geokeys);
      ...
      description = "stateplane27 " + state_plane_lcc_nad27_list[i].zone;
      return TRUE;
    }
  }
  return FALSE;
...
BOOL CRScheck::set_state_plane_nad83_lcc(const std::string& zone, const BOOL from_geokeys, std::string& description) {
  constexpr size_t state_plane_lcc_nad83_count = sizeof(state_plane_lcc_nad83_list) / sizeof(state_plane_lcc_nad83_list[0]);

  for (size_t i = 0; i < state_plane_lcc_nad83_count; ++i) {
    if (zone == state_plane_lcc_nad83_list[i].zone) {
      set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, from_geokeys);
      ...
      description = "stateplane83 " + state_plane_lcc_nad83_list[i].zone;
      return TRUE;
    }
  }
  return FALSE;
...
BOOL CRScheck::set_state_plane_nad27_tm(const std::string& zone, const BOOL from_geokeys, std::string& description) {
  constexpr size_t state_plane_tm_nad27_count = sizeof(state_plane_tm_nad27_list) / sizeof(state_plane_tm_nad27_list[0]);

  for (size_t i = 0; i < state_plane_tm_nad27_count; ++i) {
    if (zone == std::string(state_plane_tm_nad27_list[i].zone)) {
      set_ellipsoid(crs::CRS_ELLIPSOID_NAD27, from_geokeys);
      set_transverse_mercator_projection(state_plane_tm_nad27_list[i].falseEasting, state_plane_tm_nad27_list[i].falseNorthing, state_plane_tm_nad27_list[i].latOriginDegree, state_plane_tm_nad27_list[i].longMeridianDegree, state_plane_tm_nad27_list[i].scaleFactor, from_geokeys, nullptr);
      description = "stateplane27 " + state_plane_tm_nad27_list[i].zone;
      return TRUE;
    }
  }
  return FALSE;
...
BOOL CRScheck::set_state_plane_nad83_tm(const std::string& zone, const BOOL from_geokeys, std::string& description) {
  constexpr size_t state_plane_tm_nad83_count = sizeof(state_plane_tm_nad83_list) / sizeof(state_plane_tm_nad83_list[0]);

  for (size_t i = 0; i < state_plane_tm_nad83_count; ++i) {
    if (zone == std::string(state_plane_tm_nad83_list[i].zone)) {
      set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, from_geokeys);
      set_transverse_mercator_projection(state_plane_tm_nad83_list[i].falseEasting, state_plane_tm_nad83_list[i].falseNorthing, state_plane_tm_nad83_list[i].latOriginDegree, state_plane_tm_nad83_list[i].longMeridianDegree, state_plane_tm_nad83_list[i].scaleFactor, from_geokeys, nullptr);
      description = "stateplane83 " + state_plane_tm_nad83_list[i].zone;
      return TRUE;
    }
  }
  return FALSE;
...
BOOL CRScheck::set_coordinates_from_ProjLinearUnitsGeoKey(U16 value)
{
  ...
  case 9003: // Linear_Foot_US_Survey
    ...
    break;
  default:
//    LASMessage(LAS_WARNING, "set_VerticalUnitsGeoKey: look-up for %d not implemented", value);
    return FALSE;
  }
  return TRUE;
}
...
namespace epsg {
  constexpr short EPSG_IRENET95_Irish_Transverse_Mercator = 2157;
  constexpr short EPSG_ETRS89_Poland_CS92 = 2180;
  constexpr short EPSG_NZGD2000 = 2193;
  constexpr short EPSG_NAD83_Maryland_ftUS = 2248;
  constexpr short EPSG_NAD83_HARN_UTM2_South_American_Samoa = 2195;
  constexpr short EPSG_NAD83_HARN_Virginia_North_ftUS = 2924;
  constexpr short EPSG_NAD83_HARN_Virginia_South_ftUS = 2925;
  constexpr short EPSG_Reseau_Geodesique_Francais_Guyane_1995 = 2972;
  constexpr short EPSG_NAD83_Oregon_Lambert = 2991;
  constexpr short EPSG_NAD83_Oregon_Lambert_ft = 2992;
  constexpr short EPSG_SWEREF99_TM = 3006;
  constexpr short EPSG_ETRS89_ETRS_LCC = 3034;
  constexpr short EPSG_ETRS89_ETRS_TM34 = 3046;
  constexpr short EPSG_ETRS89_ETRS_TM35 = 3047;
  constexpr short EPSG_ETRS89_ETRS_TM36 = 3048;
  constexpr short EPSG_ETRS89_ETRS_TM35FIN = 3067;
  constexpr short EPSG_Fiji_1956_UTM60_South = 3141;
  constexpr short EPSG_Fiji_1956_UTM1_South = 3142;
  constexpr short EPSG_Fiji_Map_Grid_1986 = 3460;
  constexpr short EPSG_NAD83_NSRS2007_Maryland_ftUS = 3582;
  constexpr short EPSG_Slovene_National_Grid_1996 = 3794;
  constexpr short EPSG_MGI_1901_Slovene_National_Grid = 3912;
  constexpr short EPSG_RGF93_CC42 = 3942;
  constexpr short EPSG_RGF93_CC43 = 3943;
  constexpr short EPSG_RGF93_CC44 = 3944;
  constexpr short EPSG_RGF93_CC45 = 3945;
  constexpr short EPSG_RGF93_CC46 = 3946;
  constexpr short EPSG_RGF93_CC47 = 3947;
  constexpr short EPSG_RGF93_CC48 = 3948;
  constexpr short EPSG_RGF93_CC49 = 3949;
  constexpr short EPSG_RGF93_CC50 = 3950;
  constexpr short EPSG_ETRS89_DKTM1 = 4093;
  constexpr short EPSG_ETRS89_DKTM2 = 4094;
  constexpr short EPSG_ETRS89_DKTM3 = 4095;
  constexpr short EPSG_ETRS89_DKTM4 = 4096;
  constexpr short EPSG_ETRS89_UTM32_north_zE_N = 4647;
  constexpr short EPSG_ETRS89_NTM_zone_5 = 5105;
  constexpr short EPSG_ETRS89_NTM_zone_6 = 5106;
  constexpr short EPSG_ETRS89_NTM_zone_7 = 5107;
  constexpr short EPSG_ETRS89_NTM_zone_8 = 5108;
  constexpr short EPSG_ETRS89_NTM_zone_9 = 5109;
  constexpr short EPSG_ETRS89_NTM_zone_10 = 5110;
  constexpr short EPSG_ETRS89_NTM_zone_11 = 5111;
  constexpr short EPSG_ETRS89_NTM_zone_12 = 5112;
  constexpr short EPSG_ETRS89_NTM_zone_13 = 5113;
  constexpr short EPSG_ETRS89_NTM_zone_14 = 5114;
  constexpr short EPSG_ETRS89_NTM_zone_15 = 5115;
  constexpr short EPSG_ETRS89_NTM_zone_16 = 5116;
  constexpr short EPSG_ETRS89_NTM_zone_17 = 5117;
  constexpr short EPSG_ETRS89_NTM_zone_18 = 5118;
  constexpr short EPSG_ETRS89_NTM_zone_19 = 5119;
  constexpr short EPSG_ETRS89_NTM_zone_20 = 5120;
  constexpr short EPSG_ETRS89_NTM_zone_21 = 5121;
  constexpr short EPSG_ETRS89_NTM_zone_22 = 5122;
  constexpr short EPSG_ETRS89_NTM_zone_23 = 5123;
  constexpr short EPSG_ETRS89_NTM_zone_24 = 5124;
  constexpr short EPSG_ETRS89_NTM_zone_25 = 5125;
  constexpr short EPSG_ETRS89_NTM_zone_26 = 5126;
  constexpr short EPSG_ETRS89_NTM_zone_27 = 5127;
  constexpr short EPSG_ETRS89_NTM_zone_28 = 5128;
  constexpr short EPSG_ETRS89_NTM_zone_29 = 5129;
  constexpr short EPSG_ETRS89_NTM_zone_30 = 5130;
  constexpr short EPSG_ETRS89_UTM33_north_zE_N = 5650;
  constexpr short EPSG_OSGB_1936 = 27700;
  constexpr short EPSG_Belgian_Lambert_1972 = 31370;
}  // namespace epsg
...
static const std::string epsg_descriptions[] =
{
...
BOOL CRScheck::set_projection_from_ProjectedCSTypeGeoKey(const U16 value, std::string& description) {
  I32 ellipsoid_id = -1;
  ...
  case 3157: // NAD83(CSRS) / UTM zone 10N
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_NAD83;
    break;
  ...
  case 23038: // PCS_ED50_UTM_zone_38N
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_Inter;
    break;
  ...
  case 23853: // PCS_ID74_UTM_zone_53N
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_ID74;
    break;
  ...
  case 26722: // PCS_NAD27_UTM_zone_22N
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_NAD27;
    break;
  ...
  case 28358: // PCS_GDA94_MGA_zone_58
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_GDA94;
    break;
  ...
  case 29122: // PCS_SAD69_UTM_zone_22N
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_SAD69;
    break;
  ...
  case 32260: // PCS_WGS72_UTM_zone_60N 
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_WGS72;
    break;
  ...
  case 32660: // PCS_WGS84_UTM_zone_60N
    ...
    ellipsoid_id = crs::CRS_ELLIPSOID_WGS84;
    break;
  ...
  if (ellipsoid_id == -1)
  {
    if (utm_zone != -1) ellipsoid_id = crs::CRS_ELLIPSOID_WGS84;
    else if (!sp.empty())
      ellipsoid_id = (sp_nad27 ? crs::CRS_ELLIPSOID_NAD27 : crs::CRS_ELLIPSOID_NAD83);
  }
  ...
  if (value == epsg::EPSG_IRENET95_Irish_Transverse_Mercator)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                               // GRS 1980
    set_transverse_mercator_projection(600000.0, 750000.0, 53.5, -8.0, 0.99982, TRUE, nullptr);  // "IRENET95 / Irish Transverse Mercator"
    set_coordinates_in_meter(TRUE);
    description = "IRENET95 / Irish Transverse Mercator";
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_Poland_CS92)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                               // GRS 1980
    set_transverse_mercator_projection(500000.0, -5300000.0, 0.0, 19.0, 0.9993, TRUE, nullptr);  // "ETRS89 / Poland CS92"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / Poland CS92";
    return TRUE;
  }
  else if (value == epsg::EPSG_NZGD2000)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_transverse_mercator_projection(1600000.0, 10000000.0, 0.0, 173.0, 0.9996, TRUE, nullptr); // "NZGD2000 / New Zealand Transverse Mercator 2000"
    set_coordinates_in_meter(TRUE);
    description = "NZGD2000";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_Maryland_ftUS)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_lambert_conformal_conic_projection(400000.0, 0.0, 37.66666666666666, -77, 37.66666666666666, 38.3, TRUE, nullptr); // "NAD83 / Maryland (ftUS)"
    set_coordinates_in_survey_feet(TRUE);
    description = "NAD83 / Maryland (ftUS)";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_HARN_UTM2_South_American_Samoa)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                                 // GRS 1980
    set_transverse_mercator_projection(500000.0, 10000000.0, 0.0, -171.0, 0.9996, TRUE, nullptr);  // "NAD83(HARN) / UTM zone 2S (American Samoa)"
    set_coordinates_in_meter(TRUE);
    description = "UTM zone 2S (American Samoa)";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_HARN_Virginia_North_ftUS)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_lambert_conformal_conic_projection(3500000.0, 2000000.0, 37.66666666666666, -78.5, 39.2, 38.03333333333333, TRUE, nullptr); // "NAD83(HARN) / Virginia North (ftUS)"
    set_coordinates_in_survey_feet(TRUE);
    description = "NAD83(HARN) / Virginia North (ftUS)";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_HARN_Virginia_South_ftUS)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_lambert_conformal_conic_projection(3500000.0, 1000000.0, 36.33333333333334, -78.5, 37.96666666666667, 36.76666666666667, TRUE, nullptr); // "NAD83(HARN) / Virginia South (ftUS)"
    set_coordinates_in_survey_feet(TRUE);
    description = "NAD83(HARN) / Virginia South (ftUS)";
    return TRUE;
  }
  else if (value == epsg::EPSG_Reseau_Geodesique_Francais_Guyane_1995)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                         // GRS 1980
    set_transverse_mercator_projection(500000.0, 0.0, 0.0, -51.0, 0.9996, TRUE, nullptr);  // "Reseau Geodesique Francais Guyane 1995"
    set_coordinates_in_meter(TRUE);
    description = "Reseau Geodesique Francais Guyane 1995";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_Oregon_Lambert)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                                    // GRS 1980
    set_lambert_conformal_conic_projection(400000.0, 0.0, 41.75, -120.5, 43.0, 45.5, TRUE, nullptr);  // "NAD83 / Oregon Lambert"
    set_coordinates_in_meter(TRUE);
    description = "NAD83 / Oregon Lambert";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_Oregon_Lambert_ft)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                                    // GRS 1980
    set_lambert_conformal_conic_projection(400000.0, 0.0, 41.75, -120.5, 43.0, 45.5, TRUE, nullptr);  // "NAD83 / Oregon Lambert (ft)"
    set_coordinates_in_feet(TRUE);
    description = "NAD83 / Oregon Lambert (ft)";
    return TRUE;
  }
  else if (value == epsg::EPSG_SWEREF99_TM)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                        // GRS 1980
    set_transverse_mercator_projection(500000.0, 0.0, 0.0, 15.0, 0.9996, TRUE, nullptr);  // "SWEREF99 TM"
    set_coordinates_in_meter(TRUE);
    description = "SWEREF99 TM";
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_ETRS_LCC)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                                        // GRS 1980
    set_lambert_conformal_conic_projection(4000000.0, 2800000.0, 52.0, 10.0, 35.0, 65.0, TRUE, nullptr);  // "ETRS89 / ETRS-LCC"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / ETRS-LCC";
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_ETRS_TM34)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                        // GRS 1980
    set_transverse_mercator_projection(500000.0, 0.0, 0.0, 21.0, 0.9996, TRUE, nullptr);  // "ETRS89 / ETRS-TM34"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / ETRS-TM34";
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_ETRS_TM35)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                        // GRS 1980
    set_transverse_mercator_projection(500000.0, 0.0, 0.0, 27.0, 0.9996, TRUE, nullptr);  // "ETRS89 / ETRS-TM35"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / ETRS-TM35";
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_ETRS_TM36)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                        // GRS 1980
    set_transverse_mercator_projection(500000.0, 0.0, 0.0, 33.0, 0.9996, TRUE, nullptr); // "ETRS89 / ETRS-TM36"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / ETRS-TM36";
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_ETRS_TM35FIN)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                        // GRS 1980
    set_transverse_mercator_projection(500000.0, 0.0, 0.0, 27.0, 0.9996, TRUE, nullptr);  // "ETRS89 / ETRS-TM35FIN"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / ETRS-TM35FIN";
    return TRUE;
  }
  else if (value == epsg::EPSG_Fiji_1956_UTM60_South)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_Inter, TRUE);
    set_utm_projection(60, FALSE, TRUE, nullptr);  // "Fiji 1956 / UTM zone 60S"
    set_coordinates_in_meter(TRUE);
    description = "Fiji 1956 / UTM zone 60S";
  }
  else if (value == epsg::EPSG_Fiji_1956_UTM1_South)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_Inter, TRUE);
    set_utm_projection(1, FALSE, TRUE, nullptr);  // "Fiji 1956 / UTM zone 1S"
    set_coordinates_in_meter(TRUE);
    description = "Fiji 1956 / UTM zone 1S";
  }
  else if (value == epsg::EPSG_Fiji_Map_Grid_1986)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_WGS72, TRUE);
    set_transverse_mercator_projection(2000000.0, 4000000.0, -17.0, 178.75, 0.99985, TRUE, nullptr); // "Fiji 1986 / Fiji Map Grid"
    set_coordinates_in_meter(TRUE);
    description = "Fiji 1986 / Fiji Map Grid";
    return TRUE;
  }
  else if (value == epsg::EPSG_NAD83_NSRS2007_Maryland_ftUS)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                                              // GRS 1980
    set_lambert_conformal_conic_projection(400000.0, 0.0, 37.66666666666666, -77, 39.45, 38.3, TRUE, nullptr);  // "NAD83(NSRS2007) / Maryland (ftUS)"
    set_coordinates_in_survey_feet(TRUE);
    description = "NAD83(NSRS2007) / Maryland (ftUS)";
    return TRUE;
  }
  else if (value == epsg::EPSG_Slovene_National_Grid_1996)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                               // GRS 1980
    set_transverse_mercator_projection(500000.0, -5000000.0, 0.0, 15.0, 0.9999, TRUE, nullptr); // "Slovenia 1996 / Slovene National Grid"
    set_coordinates_in_meter(TRUE);
    description = "Slovenia 1996 / Slovene National Grid";
    return TRUE;
  }
  else if (value == epsg::EPSG_MGI_1901_Slovene_National_Grid)
  {
    set_ellipsoid(3, TRUE); // Bessel 1841
    set_transverse_mercator_projection(500000.0, -5000000.0, 0.0, 15.0, 0.9999, TRUE, nullptr);  // "MGI 1901 / Slovene National Grid"
    set_coordinates_in_meter(TRUE);
    description = "MGI 1901 / Slovene National Grid";
    return TRUE;    
  } else if ((epsg::EPSG_RGF93_CC42 <= value) && (value <= epsg::EPSG_RGF93_CC50))
  {
    int v = value - epsg::EPSG_RGF93_CC42;
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_lambert_conformal_conic_projection(1700000.0, 1200000.0 + v * 1000000.0, 42.0 + v, 3.0, 41.25 + v, 42.75 + v, TRUE, nullptr);
    set_coordinates_in_meter(TRUE);
    description = "RGF93 / CC" + std::to_string(value - 3900) + " Reseau_Geodesique_Francais_1993";
    return TRUE;
  } else if ((epsg::EPSG_ETRS89_DKTM1 <= value) && (value <= epsg::EPSG_ETRS89_DKTM4))
  {
    int v = ((value - epsg::EPSG_ETRS89_DKTM1) % 4) + 1;
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_transverse_mercator_projection(200000.0*v, -5000000.0, 0.0, 9.0 + (v == 1 ? 0.0 : (v == 2 ? 1.0 : (v == 3 ? 2.75 : 6.0))), 0.99998, TRUE, 0);
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / DKTM" + std::to_string(v);
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_UTM32_north_zE_N)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                         // GRS 1980
    set_transverse_mercator_projection(32500000.0, 0.0, 0.0, 9.0, 0.9996, TRUE, nullptr);  // "ETRS89 / UTM zone 32N (zE-N)"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / UTM zone 32N (zE-N)";
    return TRUE;
  } else if ((epsg::EPSG_ETRS89_NTM_zone_5 <= value) && (value <= epsg::EPSG_ETRS89_NTM_zone_30))
  {
    int v = value - 5100;
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);  // GRS 1980
    set_transverse_mercator_projection(100000.0, 1000000.0, 58.0, 0.3+v, 1.0, TRUE, 0);
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / NTM zone " + std::to_string(v);
    return TRUE;
  }
  else if (value == epsg::EPSG_ETRS89_UTM33_north_zE_N)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_NAD83, TRUE);                                          // GRS 1980
    set_transverse_mercator_projection(33500000.0, 0.0, 0.0, 15.0, 0.9996, TRUE, nullptr);  // "ETRS89 / UTM zone 33N (zE-N)"
    set_coordinates_in_meter(TRUE);
    description = "ETRS89 / UTM zone 33N (zE-N)";
    return TRUE;
  }
  else if (value == epsg::EPSG_OSGB_1936)
  {
    set_ellipsoid(1, TRUE); // Airy 1830
    set_transverse_mercator_projection(400000.0, -100000.0, 49.0, -2.0, 0.9996012717, TRUE, nullptr);  // "OSGB 1936 / British National Grid"
    set_coordinates_in_meter(TRUE);
    description = "OSGB 1936 / British National Grid";
    return TRUE;
  } 
  else if (value == epsg::EPSG_Belgian_Lambert_1972)
  {
    set_ellipsoid(crs::CRS_ELLIPSOID_Inter, TRUE);
    set_lambert_conformal_conic_projection(150000.013, 5400088.438, 90, 4.367486666666666, 51.16666723333333, 49.8333339, TRUE, nullptr); // "Belge 1972 / Belgian Lambert 72"
    set_coordinates_in_meter(TRUE);
  ...
  else if (value)
  {
    ...
    while (epsg_codes[code])
    {
      ...
      {
        description = epsg_descriptions[code];
        return TRUE;
      }
      code++;
    }
...
BOOL CRScheck::check_geokeys(std::string& description) {
  ...
  U16 num_geo_keys = lasheader->vlr_geo_keys[0].number_of_keys;
  GeoProjectionGeoKeys* geo_key = (GeoProjectionGeoKeys*)lasheader->vlr_geo_key_entries;
  F64* geokey_double_params = lasheader->vlr_geo_double_params;

  for (U32 i = 0; i < num_geo_keys; i++)
  {
    switch (geo_key[i].key_id)
    {
    case 1024: // GTModelTypeGeoKey
        if (geo_key[i].value_offset == 2)  // ModelTypeGeographic
      {
        has_projection = set_longlat_projection(TRUE, &description);
      }
      else if (geo_key[i].value_offset == 3) // ModelTypeGeocentric
      {
        has_projection = set_ecef_projection(TRUE, &description);
      }
      else if (geo_key[i].value_offset == 0) // ModelTypeUndefined
      {
    ...
    case 2048: // GeographicTypeGeoKey
      ...
      case 4009: // GCSE_Clarke1866Michigan
        ellipsoid = crs::CRS_ELLIPSOID_NAD27;
        break;
      ...
      case 4019: // GCSE_GRS1980
        ellipsoid = crs::CRS_ELLIPSOID_NAD83;
        break;
      ...
      case 4030: // GCSE_WGS84
        ellipsoid = crs::CRS_ELLIPSOID_WGS84;
        break;
      case 4267: // GCS_NAD27
        ellipsoid = crs::CRS_ELLIPSOID_NAD27;
        break;
      case 4269: // GCS_NAD83
        ...
        break;
      case 4283: // GCS_GDA94
        ellipsoid = crs::CRS_ELLIPSOID_GDA94;
        break;
      case 4322: // GCS_WGS_72
        ellipsoid = crs::CRS_ELLIPSOID_WGS72;
        break;
      case 4326: // GCS_WGS_84
        ellipsoid = crs::CRS_ELLIPSOID_WGS84;
        break;
      default:
        LASMessage(LAS_WARNING, "GeographicTypeGeoKey: look-up for %d not implemented", geo_key[i].value_offset);
      }
      break;
    case 2050: // GeogGeodeticDatumGeoKey 
      ...
      case 6030: // DatumE_WGS84
        ...
        break;
      default:
        LASMessage(LAS_WARNING, "GeogGeodeticDatumGeoKey: look-up for %d not implemented", geo_key[i].value_offset);
      }
      break;
    case 2052: // GeogLinearUnitsGeoKey 
      ...
      case 9003: // Linear_Foot_US_Survey
        break;
      default:
        LASMessage(LAS_WARNING, "GeogLinearUnitsGeoKey: look-up for %d not implemented", geo_key[i].value_offset);
      }
      break;
    case 2056: // GeogEllipsoidGeoKey
      ...
      case 7030: // Ellipse_WGS_84
        ...
        break;
      default:
        LASMessage(LAS_WARNING, "GeogEllipsoidGeoKey: look-up for %d not implemented", geo_key[i].value_offset);
      }
      break;
    case 3072: // ProjectedCSTypeGeoKey
      if (geo_key[i].value_offset != 32767)
        has_projection = set_projection_from_ProjectedCSTypeGeoKey(geo_key[i].value_offset, description);
      break;
    case 3075: // ProjCoordTransGeoKey
      ...
      case 3: // CT_ObliqueMercator
        LASMessage(LAS_WARNING, "ProjCoordTransGeoKey: CT_ObliqueMercator not implemented");
        break;
      ...
      case 11: // CT_AlbersEqualArea
        LASMessage(LAS_WARNING, "ProjCoordTransGeoKey: CT_AlbersEqualArea not implemented");
        break;
      ...
      case 16: // CT_ObliqueStereographic
        LASMessage(LAS_WARNING, "ProjCoordTransGeoKey: CT_ObliqueStereographic not implemented");
        break;
      ...
      case 27: // CT_TransvMercator_SouthOriented
        ...
        break;
      default:
        LASMessage(LAS_WARNING, "ProjCoordTransGeoKey: look-up for %d not implemented", geo_key[i].value_offset);
      }
      break;
    case 3076: // ProjLinearUnitsGeoKey
      set_coordinates_from_ProjLinearUnitsGeoKey(geo_key[i].value_offset);
      break;
    case 3078: // ProjStdParallel1GeoKey
      offsetProjStdParallel1GeoKey = geo_key[i].value_offset;
      break;
    case 3079: // ProjStdParallel2GeoKey
      offsetProjStdParallel2GeoKey = geo_key[i].value_offset;
      break;        
    case 3081: // ProjNatOriginLatGeoKey
      offsetProjNatOriginLatGeoKey = geo_key[i].value_offset;
      break;
    case 3082: // ProjFalseEastingGeoKey
      offsetProjFalseEastingGeoKey = geo_key[i].value_offset;
      break;
    case 3083: // ProjFalseNorthingGeoKey
      offsetProjFalseNorthingGeoKey = geo_key[i].value_offset;
      break;
    case 3088: // ProjCenterLongGeoKey
      offsetProjCenterLongGeoKey = geo_key[i].value_offset;
      break;
    case 3092: // ProjScaleAtNatOriginGeoKey
      offsetProjScaleAtNatOriginGeoKey = geo_key[i].value_offset;
      break;
    case 4096: // VerticalCSTypeGeoKey 
      set_vertical_from_VerticalCSTypeGeoKey(geo_key[i].value_offset);
      break;
    case 4099: // VerticalUnitsGeoKey
      set_elevation_from_VerticalUnitsGeoKey(geo_key[i].value_offset);
      break;
    }
  }
  ...
  if (!has_projection)
  {
    if (user_defined_projection == 1)
    {
          ...
          (offsetProjScaleAtNatOriginGeoKey >= 0))
      {
        ...
        description = "generic transverse mercator";
        has_projection = TRUE;
      }
    }
    else if (user_defined_projection == 8)
    {
          ...
          (offsetProjStdParallel2GeoKey >= 0))
      {
        ...
        description = "generic lambert conformal conic";
        has_projection = TRUE;
      }
    }
  }
