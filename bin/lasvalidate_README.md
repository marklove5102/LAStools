...
A simple tool to determine if LAS files conform to the 
ASPRS LAS 1.0 to 1.5 specifications.
...
reports validation for all input LAS file lidar1.laz and lidar2.laz 
to the result.json ouput file.

    lasvalidate64 -i lidar.laz -odir ../results -otxt
	
a simplified report for the input LAS file lidar1.laz to the 
result.csv ouput file.
